...
var YouTube = function() {
	...
	self.getCommentThreadsByVideoId = function(videoId, maxResults, callback, pageToken) {
		var validate = self.validate();
	 ...
	 */
	self.getPlayListItemsById = function(playlistId, maxResults, callback, pageToken) {
		var validate = self.validate();
